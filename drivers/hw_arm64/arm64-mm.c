 ...
 */
void mm_pr_aa64mmfr0_el1_reg(void)
{
...
void mm_pr_tcr_el1_reg(void)
{
	...
	pr_info("\t\t Size offset of the memory region addressed by ttbr1_el1 is 2^%d", (64 - t1sz));
	...
	t0sz = tcr_el1 & 0x1F;
	pr_info("\t\t Size offset of the memory region addressed by ttbr0_el1 is 2^%d", (64 - t0sz));
}
